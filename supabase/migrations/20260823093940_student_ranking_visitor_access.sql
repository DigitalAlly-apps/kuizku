-- Ranking for a visitor who has not started an exam.  It returns only the
-- public leaderboard payload and never creates or changes a submission.
...
begin
  ...
  with best_per_student as (
    ...
    select rank() over (order by b.score desc)::integer as rank, b.nis, b.student_name, b.score
